...
const Education = (props) => {
  ...
  return (
    <Element name = "education" className = "fresher-template1-education">
      <Heading name = {props.education.title} bg = {props.bg} font = {props.font} />
      <div className = "fresher-template1-education-vl" style = {{backgroundColor: `${props.bg}`, height: `${vlHeight()}`}}></div>
      
      <div style = {{position: `relative`}}>
       {props.education.value[0].optional && <div className = "fresher-template1-education-1" style = {{top: `${secTop()[0]}`}} data-aos="fade-up">
        ...
        {props.education.value[1].optional && <div className = "fresher-template1-education-2" style = {{top: `${secTop()[1]}`}} data-aos="fade-up">
        ...
        {props.education.value[2].optional && <div className = "fresher-template1-education-3" style = {{top: `${secTop()[2]}`}} data-aos="fade-up">
          <div className = "u-bullet-right" style = {{backgroundColor: `${props.bg}`}}>
