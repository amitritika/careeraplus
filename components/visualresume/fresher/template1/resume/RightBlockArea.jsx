const RightBlockLogo = (props) =>{
  ...
  return (
    <div id = {id} style = {{position: `absolute`, top: `${top}`, left: `${left}`, textAlign: `center`, fontSize: `${size}`,color: `${font}`, height: `${height1}`, width: `${width1}`}}>
      <div style = {{position: `absolute`, left: `${left1}`, textAlign: `center`, borderRadius: `50%`, backgroundColor: `${bg}`, zIndex: `2`}}>
        <i className = {logo} style = {{height: `${height}`, width: `${width}`, color: `white`, lineHeight: `${line}`, fontSize: `${size1}`, zIndex: `3`}}></i>
      </div>
