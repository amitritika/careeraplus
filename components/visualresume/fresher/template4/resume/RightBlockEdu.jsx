...
const RightBlockProject = (props) =>{
  ...
  let lineT = (props.fac * 2.5).toString() + "px";
  ...
  return (
    <div id = {id} style = {{height: `${height}`, width: `${width}`, position: `absolute`, top: `${top}`, left: `${left}`, color: `${bg}`, fontFamily: `calibri`, fontSize: `${size}`, textAlign: `left`}}>
      ...
      <div style = {{top: `${top1}`, position: `absolute`, color: `${bg}`, fontWeight: `bold`, fontSize: `${size1}`}}>{year}</div>
      <div style = {{left: `${left1}`, position: `absolute`, top: `${top1}`, color: `${font}`, fontWeight: `bold`, fontSize: `${size}`}}>{degree}</div>
      <div style = {{left: `${left1}`, position: `absolute`, top: `${top2}`,  color: `${bg}`, fontWeight: `normal`, fontSize: `${size}`}}>{college}</div>
