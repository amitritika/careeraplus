...
const BlockHeading = (props) =>{
  ...
  let widthL = (props.fac * (190 - arr[1])).toString() + "px";
  ...
  return (
    <div id = {id} style = {{height: `${height}`, width: `${width}`, color: `${font}`, lineHeight: `${line}`, position: `absolute`, top: `${top}`, left: `${left}`, fontFamily: `calibri`, fontSize: `${size}`, textAlign: `left`, fontWeight: `bold`}}>
       {name}
