        ...
        if (data.error) {
            setValues({ ...values, error: data.error });
					...
					if(data.version == 0){
						...
						vdata.pesrsonalInformation.photoOption = true;
						vdata.pesrsonalInformation.title = "CONTACT";
						vdata.pesrsonalInformation.addressFull = "MIG-15, Anandvihar Colony, Arera Border, Bhopal, MP, INDIA, 461003";
						vdata.pesrsonalInformation.addressDisplay = false;
						vdata.educationalInformation.title = "EDUCATION";
						vdata.educationalInformation.degDisplay = false;
						vdata.projectInformation.title = "PROJECTS";
						vdata.projectInformation.projectDisplay = true;
						vdata.trainingInformation.title = "INDUSTRIAL EXPOSURE";
						vdata.skills.title = "SKILLS";
						vdata.hobbies.title = "HOBBIES";
						vdata.areaOfIntrest.title = "AREA OF INTRESTS";
						vdata.extraCurricular.title = "EXTRA CURRICULAR";
						props.vr(vdata);
          ...
          <div className= "container">
            ...
            <div className="form-group">
              ...
              <input 
                type = "text"
                className="form-control"
                defaultValue={visualresume.pesrsonalInformation.title}
                onChange= {handleChangePersonalInformation("title")}>
              </input>
