      ...
      props.skills.value.map ((s, i)=> {
        ...
        return (
          <div className = "col-lg-6">
             <div className = "pro-template1-skills-bar">
              <div className = "pro-template1-skills-bar__text">
                {props.skills.value[i].value}
              </div>
              <div className = "pro-template1-skills-bar__bar" style = {{backgroundColor: `${props.font}`}}>

              </div>
              <div className = "pro-template1-skills-bar__rating" style = {{width: `${rat1}`}}>
  ...
  return (
    <Element name = {props.name} className = "pro-template1-skills" >
      ...
      <div className = "container">
        <div className = "pro-template1-skills__sec row" style = {{height: `${heightFn()}`}}>
