  ...
  return (
    <React.Fragment>
      ...
      <div className = "pro-template1-main">
        ...
        {display.trainingInfo && <Trainings  training = {props.visualresumedata.data.trainingInformation} bg = {props.bg} font = {props.font} name = {name.trainingInfo} />}
        ...
        {display.porInfo && <POR  por = {props.visualresumedata.data.porInformation} bg = {props.bg} font = {props.font} name = {name.porInfo} />}
