...
const WorkexpInfo = (props) =>{
  ...
  const [list, setList] = useState(visualresumepro.workexpInformation.value);
  ...
  const handleDeleteRole = (idx, i) => {
    let arr = visualresumepro.workexpInformation.value[i].role;
    let visualresumeCopy = visualresumepro;
    arr.splice(idx, 1);
  ...
  <div className= "container">
      ...
      <input 
        type = "text"
        className="form-control"
        defaultValue={visualresumepro.workexpInformation.title}
