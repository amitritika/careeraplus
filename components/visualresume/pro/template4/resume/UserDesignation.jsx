const UserDesignation = (props) =>{
  ...
  let width = (props.fac * 125).toString() + "px";
  ...
  return (
    <div id = {id} style = {{height: `${height}`, width: `${width}`, lineHeight: `${line}`, position: `absolute`, top: `${top}`, left: `${left}`, fontFamily: `calibri`, fontSize: `${size}`, textAlign: `left`, fontWeight: `bold`, color: `white`}}>
       {name}
    </div>
  )
}
