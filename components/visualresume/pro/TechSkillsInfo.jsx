...
const TechSkillsInfo = (props) =>{
  ...
  const [list, setList] = useState(visualresumepro.techSkillsInformation.value);
  ...
  const handleDelete = (idx) => {
    ...
    arr.splice(idx, 1);
    setList(arr);
    visualresumeCopy.techSkillsInformation.value = arr;
    vr(visualresumeCopy)
  }
  ...
  const handleChange = (n, idx) => e => {
      let visualresumeCopy = visualresumepro;
      visualresumeCopy.techSkillsInformation.value[idx][n] = e.target.value;
      vr(visualresumeCopy);
    };
  
  const handleTitle = e => {
    let visualresumeCopy = visualresumepro;
    visualresumeCopy.techSkillsInformation.title = e.target.value;
    vr(visualresumeCopy);
  }
  ...
  <div className= "container">
      ...
      <input 
        type = "text"
        className="form-control"
        defaultValue={visualresumepro.techSkillsInformation.title}
