...
const RightBlockProject = (props) =>{
  ...
  return (
    <div id = {id} style = {{height: `${height}`, width: `${width}`, position: `absolute`, top: `${top}`, left: `${left}`, color: `${bg}`, fontFamily: `calibri`, fontSize: `${size}`, textAlign: `left`}}>
      ...
      <div style = {{left: `${left1}`, position: `absolute`, top: `${top1}`, color: `${bg}`, fontWeight: `bold`, fontSize: `${size}`}}>{cgpa}</div>
      
      <div style = {{left: `${left2}`, position: `absolute`, top: `${top1}`, color: `${bg}`, fontWeight: `bold`, fontSize: `${size}`}}>{year}</div>
      <div style = {{left: `${left3}`, position: `absolute`, top: `${top1}`, color: `${bg}`, fontWeight: `normal`, fontSize: `${size}`}}>{college}</div>
