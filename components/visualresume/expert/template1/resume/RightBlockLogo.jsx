const RightBlockLogo = (props) =>{
  ...
  return (
    <div id = {id} style = {{position: `absolute`, top: `${top}`, left: `${left}`, textAlign: `center`, borderRadius: `50%`, backgroundColor: `${bg}`, zIndex: `2`}}>
      <i className = {name} style = {{height: `${height}`, width: `${width}`, color: `white`, lineHeight: `${line}`, fontSize: `${size}`, zIndex: `3`}}></i>
    </div>
  )
}
