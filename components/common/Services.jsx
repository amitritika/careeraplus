import { FaLayerGroup, FaTasks, FaShareAlt, FaPrint, FaPalette, FaFile} from "react-icons/fa";
const Hero = () => {

  return(
  
    <div style = {{marginTop: `6rem`}} id="services" className="services u-bg-light">
              <div className="container" data-aos="fade-up" style = {{paddingTop: `3rem`}}>
                ...
                <div className="row">
                  <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div className="icon-box-2 iconbox-2-blue">
                      <div className="icon-box-2__icon">
                        ...
                        <FaLayerGroup className = "icon-box-2__icon--2"/>
                      </div>
                  ...
                  <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
                    <div className="icon-box-2 iconbox-2-orange">
                      <div className="icon-box-2__icon">
                        <svg width="100" height="100" viewBox="0 0 600 600" className = "icon-box-2__icon--1">
                        ...
                        <FaTasks className = "icon-box-2__icon--2"/>
                      </div>
                  ...
                  <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
                    <div className="icon-box-2 iconbox-2-pink">
                      <div className="icon-box-2__icon">
                        <svg width="100" height="100" viewBox="0 0 600 600" className = "icon-box-2__icon--1">
                        ...
                        <FaShareAlt className = "icon-box-2__icon--2"/>
                      </div>
                  ...
                  <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
                    <div className="icon-box-2 iconbox-2-yellow">
                      <div className="icon-box-2__icon">
                        <svg width="100" height="100" viewBox="0 0 600 600" className = "icon-box-2__icon--1">
                        ...
                        <FaPrint className = "icon-box-2__icon--2"/>
                      </div>
                  ...
                  <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
                    <div className="icon-box-2 iconbox-2-orange-red">
                      <div className="icon-box-2__icon">
                        <svg width="100" height="100" viewBox="0 0 600 600" className = "icon-box-2__icon--1">
                        ...
                        <FaPalette className = "icon-box-2__icon--2"/>
                      </div>
                  ...
                  <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
                    <div className="icon-box-2 iconbox-2-teal">
                      <div className="icon-box-2__icon">
                        <svg width="100" height="100" viewBox="0 0 600 600" className = "icon-box-2__icon--1">
                        ...
                        <FaFile className = "icon-box-2__icon--2"/>
                      </div>
