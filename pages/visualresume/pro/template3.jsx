...
import Page1 from "../../../components/visualresume/pro/template3/Page1"
              ...
              <Row>
                ...
                <Col xs = "2" lg = "1">
                  <div style = {{width: `50px`, height: `50px`, backgroundColor: `${font}`, marginTop: `10px`}}></div>
								...
								<Col xs= "12" lg = "4">
                  <UserInformationpro vr = {vr} pr = {personalInformation} type="pro" template = "template3" userInfoDisplay = {userInfoDisplay} ref = {editSection} />
                </Col>
