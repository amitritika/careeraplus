...
import Resume from "../../../components/visualresume/pro/template2/Resume"
import Page1 from "../../../components/visualresume/pro/template2/Page1"
import {visualresumedata} from "../../../helpers/visualresume/pro"
import {componentSequence, colors} from "../../../helpers/visualresume/pro/template2/template2"
              ...
              <Row>
                ...
                <Col xs = "2" lg = "1">
                  <div style = {{width: `50px`, height: `50px`, backgroundColor: `${font}`, marginTop: `10px`}}></div>
								...
								<Col xs= "12" lg = "4">
                  <UserInformationpro vr = {vr} pr = {personalInformation} type="pro" template = "template1" userInfoDisplay = {userInfoDisplay} ref = {editSection} />
                </Col>
