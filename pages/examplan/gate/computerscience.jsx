...
const ComputerGateExamplan = () => {
	const exam = ["gate", "GATE"];
	const stream = ["computerscience", "Computer Science"];
  ...
  const head = () => (
        <Head>
            <title>
             Exam plan GATE Computer Science | {APP_NAME}
            </title>
            ...
            <link rel="canonical" href={`${DOMAIN}/examplan/gate/computerscience`} />
            <meta property="og:title" content={`${APP_NAME}`} />
            <meta property="og:description" content={`${desc}`} />
            <meta property="og:type" content="webiste" />
            <meta property="og:url" content={`${DOMAIN}/examplan/gate/computerscience`} />
            <meta property="og:site_name" content={`${APP_NAME} | Exam Plan | GATE | Computer Science`} />
...
export default ComputerGateExamplan;