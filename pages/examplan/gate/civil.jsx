...
const CivilGateExamplan = () => {
  ...
  const head = () => (
        <Head>
            ...
            <link rel="canonical" href={`${DOMAIN}/examplan/gate/civil`} />
            <meta property="og:title" content={`${APP_NAME}`} />
            <meta property="og:description" content={`${desc}`} />
            <meta property="og:type" content="webiste" />
            <meta property="og:url" content={`${DOMAIN}/examplan/gate/civil`} />
            <meta property="og:site_name" content={`${APP_NAME} | Exam Plan | GATE | Civil`} />
