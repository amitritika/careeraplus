...
const ElectricalEseExamplan = () => {
  ...
  const head = () => (
        <Head>
            <title>
             Exam plan ESE Electrical| {APP_NAME}
            </title>
            ...
            <link rel="canonical" href={`${DOMAIN}/examplan/ese/electrical`} />
            <meta property="og:title" content={`${APP_NAME}`} />
            <meta property="og:description" content={`${desc}`} />
            <meta property="og:type" content="webiste" />
            <meta property="og:url" content={`${DOMAIN}/examplan/ese/electrical`} />
            <meta property="og:site_name" content={`${APP_NAME} | Exam Plan | ESE Electrical`} />
